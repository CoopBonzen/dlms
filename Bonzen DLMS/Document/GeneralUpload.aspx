<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="GeneralUpload.aspx.vb" Inherits="Bonzen_DLMS.GeneralUpload" %>
    ...
    <table width="50%">
        <tr>
            <td class="auto-style4" style="width: 50%">
                <dx:ASPxLabel ID="lbl_GNewUpload" runat="server" Text="New Upload" />
                &nbsp;&nbsp;
                <dx:ASPxLabel ID="lbl_GNo" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td class="auto-style4" style="width: 50%">
                <dx:ASPxLabel ID="lbl_GeneralNumber" runat="server" Text="Company : " />
                &nbsp;&nbsp;
                <dx:ASPxLabel ID="lbl_GCompanyName" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
