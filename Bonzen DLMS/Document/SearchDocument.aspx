    ...
    <div class="jumbotron">
        ...
        <p class="lead">
            <dx:ASPxGridView ID="gv_quotationProposal" ClientInstanceName="gv_quotationProposal"
                AutoGenerateColumns="False" runat="server" DataSourceID="Quo_Prop" KeyFieldName="Q_ID"
                Width="894px">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="สถานะ" Name="quota_status" ReadOnly="True" VisibleIndex="8"
                        Width="8%">
                        <EditCellStyle HorizontalAlign="Center">
                        </EditCellStyle>
                        <DataItemTemplate>
