        ...
        <div>
            ...
            <p class="lead">
                ...
                <asp:SqlDataSource ID="General" runat="server" ConnectionString="<%$ ConnectionStrings:DLMSConnectionString %>"
                    ...
                    SelectCommand="SELECT * FROM [General]WHERE DATEDIFF(day,G_Date,getdate()) between 0 and 100 ORDER BY [G_ID], [G_Date] DESC " UpdateCommand="UPDATE [General] SET [Title] = @Title WHERE [G_ID] = @G_ID">
                    <DeleteParameters>
