<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="ManageUser.aspx.vb" Inherits="Bonzen DLMS.ManageUser" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="2">
                        <asp:Label runat="server" ID="lbl_UserGroup" Text="User Group :" />&nbsp;
                ...
                <tr>
                    <td valign="top" style="width: 35%">
                        <asp:ListView ID="lv_User" runat="server" DataKeyNames="user_id" DataSourceID="sds_User">
                            <LayoutTemplate>
                                <table width="95%">
                                    <tr>
                                        <td>
                                            <table class="bordercolor" cellspacing="1" cellpadding="4" width="100%">
                                                <thead>
                                                    <tr style="font-family: Sans-Serif,Tahoma; font-size: 9pt; background-color: #CCCCCC;
                                                        ...
                                                        <th>
                                                            <asp:Label runat="server" ID="lbl_active" Text="Active" />
                                                        </th>
                                                        <th>
                                                        </th>
                                                    </tr>
                                    ...
                                    <tr>
                                        <td id="Td1" runat="server" style="text-align: center; background-color: #CCCCCC;
                            ...
                            <EditItemTemplate>
                                <tr id="Tr2" runat="server">
                                    <td id="Td14" runat="server">
                                        <asp:TextBox ID="user_nameTextBox" runat="server" Text='<%# Bind("user_name") %>' MaxLength="100" />
                                    </td>
                        ...
                        <asp:SqlDataSource runat="server" ID="sds_User" ConnectionString="<%$ ConnectionStrings:Bonzen_DLMS.DlmsDataContext %>"
                    ...
                    <td valign="top" style="width: 65%">
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="width: 30%; float: left; height: 130px">
                                                        ...
                                                        <div style="height: 25px">
                                                        <asp:Label ID="lbl_FullName" runat="server" Text="Full Name :" />

                                                        </div>
                                                        <div style="height: 25px" id="div_ChooseUserGroup" runat="server">
                                                        <asp:Label ID="lbl_ChooseUserGroup" runat="server" Text="User Group :" />
                                                        </div>
                                                    </div>
                                                    <div style="width: 65%; float: left; height: 130px">
                                                        <div style="height: 25px;">
                                                        <asp:TextBox ID="txt_UserName" runat="server" Width="170px" />
                                                        </div>
                                                        <%--<div style="height: 25px">
                                                            <asp:TextBox ID="txt_Password" runat="server" Width="170px" TextMode="Password"></asp:TextBox>
                                                        </div>--%>
                                                        <div style="height: 25px">
                                                        <asp:TextBox ID="txt_FullName" runat="server" Width="170px" />
                                                        </div>
                        ...
                        <asp:LinqDataSource ID="lds_User" runat="server" ContextTypeName="Bonzen DLMS.DlmsDataContext"
